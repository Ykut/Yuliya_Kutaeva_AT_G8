...
public class TransportableProcessorRunner {
    public static void main(String[] args) {
        TransportableProcessor transportable = new TransportableProcessor();
        ...
        transportable.runTransportable(transportableCopter);
        transportable.runTransportable(transportablePlane);
        transportable.runTransportable(transportableRocket);
        transportable.runTransportable(transportableCar);
        transportable.runTransportable(transportableMoped);
        transportable.runTransportable(transportableMotorbike);
        transportable.runTransportable(aircraftCopter);
        transportable.runTransportable(aircraftPlane);
        transportable.runTransportable(aircraftRocket);
        transportable.runTransportable(vehicleCar);
        transportable.runTransportable(vehicleMoped);
        transportable.runTransportable(vehicleMotorbike);
        //transportable.runTransportable(flyableCopter);
        //transportable.runTransportable(flyablePlane);
        //transportable.runTransportable(flyablePlane);
        //transportable.runTransportable(flyableRocket);
        //transportable.runTransportable(rideableCar);
        //transportable.runTransportable(rideableMoped);
        //transportable.runTransportable(rideableMotorbike);
        transportable.runTransportable(aCopter);
        transportable.runTransportable(aPlane);
        transportable.runTransportable(aRocket);
        transportable.runTransportable(aCar);
        transportable.runTransportable(aMoped);
        transportable.runTransportable(aMotorbike);

        transportable.runTransportable(aCar, 23, 242);
        transportable.runTransportable(transportableMoped, 93,7);
